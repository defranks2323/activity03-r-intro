...
**Response**:
I noticed that the problem was the quotation marks affecting the separating commas. To fix this I just removed them 
...
**Response**:
The percent sign was wrong and instead we needed a dollar sign
